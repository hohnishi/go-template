...
CREATE SMALLFILE TABLESPACE "USERS" LOGGING  DATAFILE  'C:\app\Administrator\oradata\ORCL\PLGDB\users01.dbf' SIZE 5M REUSE AUTOEXTEND ON NEXT  1280K MAXSIZE UNLIMITED  EXTENT MANAGEMENT LOCAL  SEGMENT SPACE MANAGEMENT  AUTO;
